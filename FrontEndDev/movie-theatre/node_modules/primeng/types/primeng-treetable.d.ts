...
declare class TreeTable extends BaseComponent<TreeTablePassThrough> implements BlockableUI {
    ...
    filterTimeout: any;
    _colGroupTemplate: Nullable<TemplateRef<TreeTableColumnsTemplateContext>>;
    ...
    _headerTemplate: Nullable<TemplateRef<TreeTableColumnsTemplateContext>>;
    headerTemplate: Nullable<TemplateRef<TreeTableColumnsTemplateContext>>;
    _bodyTemplate: Nullable<TemplateRef<TreeTableBodyTemplateContext>>;
    ...
    _emptyMessageTemplate: Nullable<TemplateRef<TreeTableEmptyMessageTemplateContext>>;
    emptyMessageTemplate: Nullable<TemplateRef<TreeTableEmptyMessageTemplateContext>>;
    _paginatorLeftTemplate: Nullable<TemplateRef<void>>;
    paginatorLeftTemplate: Nullable<TemplateRef<void>>;
    _paginatorRightTemplate: Nullable<TemplateRef<void>>;
    paginatorRightTemplate: Nullable<TemplateRef<void>>;
    _paginatorDropdownItemTemplate: Nullable<TemplateRef<void>>;
    paginatorDropdownItemTemplate: Nullable<TemplateRef<void>>;
    _frozenHeaderTemplate: Nullable<TemplateRef<TreeTableColumnsTemplateContext>>;
    frozenHeaderTemplate: Nullable<TemplateRef<TreeTableColumnsTemplateContext>>;
    _frozenBodyTemplate: Nullable<TemplateRef<void>>;
    frozenBodyTemplate: Nullable<TemplateRef<void>>;
    _frozenFooterTemplate: Nullable<TemplateRef<TreeTableColumnsTemplateContext>>;
    frozenFooterTemplate: Nullable<TemplateRef<TreeTableColumnsTemplateContext>>;
    _frozenColGroupTemplate: Nullable<TemplateRef<TreeTableColumnsTemplateContext>>;
    ...
    _reorderIndicatorUpIconTemplate: Nullable<TemplateRef<void>>;
    reorderIndicatorUpIconTemplate: Nullable<TemplateRef<void>>;
    _reorderIndicatorDownIconTemplate: Nullable<TemplateRef<void>>;
    ...
    _togglerIconTemplate: Nullable<TemplateRef<TreeTableTogglerIconTemplateContext>>;
